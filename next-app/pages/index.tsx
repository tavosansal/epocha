      ...
      <main className="container py-6">
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 auto-rows-fr">
          ...
          <div className="bg-card shadow rounded p-4 h-full flex items-center justify-center">
            <button className="px-3 py-1 border rounded border-border" onClick={addConverter}>
              + Add New
            </button>
          </div>
        </div>
        ...
        <div className="mt-6 bg-card p-4 rounded shadow">
          ...
          <p className="text-sm text-muted-foreground">
            The Unix timestamp represents the number of seconds since 00:00:00 UTC on January 1, 1970.
          </p>
        </div>
      </main>
    </div>
